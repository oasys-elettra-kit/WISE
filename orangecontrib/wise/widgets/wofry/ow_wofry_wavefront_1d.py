...
class OWWofryWavefront1d(WiseWidget):
    name = "WofryWavefront1d"
    id = "WofryWavefront1d"
    description = "WofryWavefront1d"
    icon = "icons/wofry_wavefront_1d.png"
    priority = 1
    category = ""
    ...
    def do_wise_calculation(self):
        ...
        wise_inner_source = WofryWavefront_1d(wofry_wavefront=self.wofry_wavefront,
    ...
    def extract_wise_output_from_calculation_output(self, calculation_output):
        ...
        wise_source.set_property("source_on_mirror_focus", 0)
...
class WofryWavefront_1d(object):
    #================================================
    #     __init__
    #================================================
    ...
    def EvalField_XYLab(self, x = numpy.array(None), y = numpy.array(None)):
        ...
        wav_x = numpy.zeros(len(wav_E))
        wav_y = self.wofry_wavefront._electric_field_array.get_abscissas()
